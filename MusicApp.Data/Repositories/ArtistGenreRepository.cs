...
{
    public class ArtistGenreRepository : CrudRepository<ArtistGenre>, IArtistGenreRepository
    {
        public ArtistGenreRepository(MusicAppDbContext context) : base(context) { }
